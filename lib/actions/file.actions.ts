...
const createQueries = (
  ...
  // TODO:- Search, sort, limits, pagination, etc.
  return queries;
};
...
export const uploadFile = async ({
  ...
  try {
    // Convert the file to a Buffer for Node.js (No FileReader needed)
    const fileBuffer = Buffer.from(await file.arrayBuffer());

    // Create the file input for Appwrite storage
